...
const Home: FC = () => {
  ...
  return (
    <div className="text-left">
      <div className="text-center bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 min-w-full p-14 shawdow-lg break-words">
      ...
      <div className="mt-4 md:mt-9 overflow-hidden mx-10 md:text-left md:text-center">
        ...
        <div className="mt-8">
          ...
          <p className="text-base mt-1 md:mt-2">
            <p className="ctox text-xs underline" onClick={e => clickHandler(isHidden, setIsHidden, e)}>Click to see/hide</p>
